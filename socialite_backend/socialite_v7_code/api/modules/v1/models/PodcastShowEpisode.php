...
class PodcastShowEpisode extends \yii\db\ActiveRecord
{
    ...
    public function getImageUrl()
    {
        if($this->image){
            ...
            return $modelFileUpload->getFileUrl($modelFileUpload::TYPE_PODCAST_SHOW,$this->image);
    ...
    public function getAudioUrl()
    {
        if($this->audio){
            $modelFileUpload = new FileUpload();
            return $modelFileUpload->getFileUrl($modelFileUpload::TYPE_PODCAST_SHOW,$this->audio);
