...
<div class="countryy-form">
    ...
    [
     'prompt' => 'Select Banner Type',
       'onchange' => ' $.post( "'.Yii::$app->urlManager->createUrl(['tv-banner/banner-reference','id'=>'']).'"+$(this).val(), function( data ) {
        $( "select#tvbanner-reference_id" ).html( data );
    });',
...
$js=<<< JS
  ...
  $(document).ready(function(){
    $('#tvbanner-banner_type').change(function(){
        var id = $(this).val();
        // alert("hello"+ id);
