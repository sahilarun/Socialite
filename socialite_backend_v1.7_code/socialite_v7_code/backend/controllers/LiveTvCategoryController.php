...
use backend\models\LiveTvCategorySearch;
...
class LiveTvCategoryController extends Controller
{
    ...
    {
        $searchModel = new LiveTvCategorySearch();
    ...
    public function actionDelete($id)
    {
        ...
        $userModel->status =  LiveTvCategory::STATUS_DELETED;
    ...
    {
        if (($model = LiveTvCategory::findOne($id)) !== null) {
            return $model;
        }
