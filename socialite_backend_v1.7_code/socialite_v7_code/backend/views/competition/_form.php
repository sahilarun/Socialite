            ...
            <?php
                    ...
                    foreach($model->competitionPosition as $competitionPosition){ ?>
                        <div  class="copy_container">
                            ...
                            <label class="control-label" for="competition-price">Competition Position</label>
                                <input type="text"  class="form-control" value="<?php echo $competitionPosition->title ?>"  name="competitionPosition[]">
                            ...
                            <div class="form-group">
                            <label class="control-label" for="competition-price">Award Value</label>
                                <input type="text"  class="form-control" value="<?php echo $competitionPosition->award_value ?>" name="competitionAward[]">
